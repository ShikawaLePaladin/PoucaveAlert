...
| `/pa testmove` | **SIMULER Shackle** avec countdown 3...2...1 |
...
2. Détection du debuff "Shackle of the Legion" (variantes en anglais/français)
3. Enregistrement de la position du joueur
4. Vérification du mouvement toutes les 0.1 secondes (seuil: 0.5 yard)
5. **Anti-spam**: Max 1 alerte par joueur par 2 secondes
...
3. Recherche **insensible à la casse** dans la liste des sorts interdits
4. Annonce normale OU alerte spéciale selon le sort
5. Statistiques: compte les dispels normaux et interdits
...
L'addon enregistre automatiquement:
- 📈 Nombre de Shackles détectés
- 📈 Nombre d'alertes de mouvement
- 📈 Nombre de dispels normaux enregistrés
- 📈 Nombre de dispels interdits (🚨 wipe prevention!)
